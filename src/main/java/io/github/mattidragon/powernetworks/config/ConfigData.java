...
public record ConfigData(TransferRatesCategory transferRates, TexturesCategory textures, MiscCategory misc) {
    public static final ConfigData DEFAULT = new ConfigData(TransferRatesCategory.DEFAULT, TexturesCategory.DEFAULT, MiscCategory.DEFAULT);
